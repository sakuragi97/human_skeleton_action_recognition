...
class RandomMasking:
    ...
    def __call__(self, results):
        ...
        # results['input1'] = self.random_masking(skeleton)
        # results['input2'] = self.random_masking(skeleton)
        return results
...
#     def __call__(self, results):
#         results['input1'] = self.random_move(results['input'])
#         results['input1'] = self.random_shift(results['input1'])
        
#         results['input2'] = self.random_move(results['input'])
#         results['input2'] = self.random_move(results['input2'])
#         return results
...
class RandomRot:
    ...
    def __call__(self, results):
        skeleton = results['keypoint']
        skeleton = np.transpose(skeleton, (3,1,2,0)) # EDIT
        ...
        results['keypoint'] = np.transpose(results['keypoint'], (3,1,2,0)) #EDIT
