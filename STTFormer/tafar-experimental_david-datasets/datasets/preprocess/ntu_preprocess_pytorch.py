...
if __name__ == "__main__":
    for num_class in ['60', '120']:
        base_path = '/home/dav86141/data/NTU_Data/NTU_' + num_class + '/'               # where you save NTU data
        ...
        dsamp_train, dsamp_test, lab_tr, lab_te = preprocess_pipeline(base_path, tr_path, te_path, train_name, test_name,
                                                                      "cross_subject_data", dsamp_frame=60)
